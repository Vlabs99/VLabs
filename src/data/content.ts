...
export const ROUTEGUARD_APK_DOWNLOAD_URL =
  'https://drive.google.com/uc?export=download&id=1bCeKaJGXkxqknyC78hPUDeTh7cI1lFo9'
export const VCHAT_WEB_LIVE_DEMO_URL = 'https://v-chat-web.vercel.app/chat'
export const VCHAT_WEB_GITHUB_URL = 'https://github.com/Vlabs99/VChat-Web'
...
export const routeguardProject = {
  ...
  tagline: 'Community-Driven Road Awareness Platform',
  summary:
  ...
  keyFeatures: [
    ...
    'Roadblock and traffic updates',
    'Temporary reports with automatic expiry',
    'Community verification and trust system',
...
export const portfolioProjects: PortfolioProject[] = [
  {
    ...
    summary:
      'RouteGuard is a community-powered platform that helps people stay informed about road conditions in real time. Users can report traffic police checkpoints, roadblocks, accidents, road damage, construction work, and other road events. Reports are verified by the community and automatically expire after a configurable time to keep information accurate and relevant.',
    banner: assetUrl('screenshots/routeguard-main.png'),
    logo: assetUrl('screenshots/routeguard-logo.png'),
    techBadges: [
      'Java',
      'Android',
      'Firebase Authentication',
    ...
    detailPath: '/projects/routeguard',
    githubUrl: ROUTEGUARD_GITHUB_URL,
    apkUrl: ROUTEGUARD_APK_DOWNLOAD_URL,
  },
  {
    id: 'vchat',
    name: 'VChat Android',
    tagline: 'Realtime Android Messenger Platform',
    status: 'Production Ready',
    summary:
      'A production-grade realtime Android messenger engineered in Java with Firebase. Built around modular manager/helper layers, live Firestore snapshot listeners, friend request graph, group chats, typing indicators, pinned messages, and defensive crash-resistant lifecycle handling.',
    banner: assetUrl('screenshots/vchat profile image.png'),
    logo: assetUrl('screenshots/Logo.webp'),
    techBadges: [
      'Java',
      'Android Studio',
      'Firestore',
    ...
    detailPath: '/projects/vchat',
    githubUrl: 'https://github.com/Vlabs99/Vchat',
    apkUrl: APK_DOWNLOAD_URL,
  },
  {
    id: 'vchat-web',
    name: 'VChat Web',
    tagline: 'Modern React Companion Client',
    status: 'Live Demo',
    summary:
      'A modern web companion client for VChat built with React, TypeScript, and Tailwind CSS. Shares the same Firestore backend schema for seamless cross-device communication, offering instant web access to real-time messaging, private chats, live status sync, and responsive web UI.',
    banner: assetUrl('screenshots/vchat-private-chat.webp'),
    logo: assetUrl('screenshots/Logo.webp'),
    techBadges: [
      'React',
      'TypeScript',
    ...
    detailPath: '/projects/vchat-web',
    githubUrl: VCHAT_WEB_GITHUB_URL,
    liveDemoUrl: VCHAT_WEB_LIVE_DEMO_URL,
  },
]
...
export const routeguardGallery = [
  {
    ...
    image: '/screenshots/routeguard-home.png',
  },
  {
    ...
    image: '/screenshots/routeguard-report.png',
  },
  {
  ...
  },
  {
    ...
    image: '/screenshots/routeguard-profile.png',
  },
  {
    ...
    image: '/screenshots/routeguard-my-reports.png',
  },
]
...
export const socialLinks: {
  ...
  handle: string
    ...
    },
    {
      ...
      handle: 'vishwarajsinh-chudasama',
    },
    {
      platform: 'github',
      label: 'GitHub',
